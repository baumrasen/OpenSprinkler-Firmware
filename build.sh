...
if [ "$1" == "demo" ]; then
	...
	echo "Compiling firmware..."
	g++ -o OpenSprinkler -DOSPI main.cpp OpenSprinkler.cpp program.cpp opensprinkler_server.cpp utils.cpp weather.cpp gpio.cpp etherport.cpp mqtt.cpp libSSD1306Display.cpp -I./../libSSD1306/lib -lpthread -lmosquitto
fi
