...
#define SSD1306_SET_CONTRAST_CONTROL 0xFF        // 0x81 - SH110X_SETCONTRAST 0x81
#define SSD1306_DISPLAY_ALL_ON_RESUME 0xA4       // SH110X_DISPLAYALLON_RESUME 0xA4
#define SSD1306_DISPLAY_ALL_ON 0xA5              // SH110X_DISPLAYALLON 0xA5
#define SSD1306_NORMAL_DISPLAY 0xA6              // SH110X_NORMALDISPLAY 0xA6
#define SSD1306_INVERT_DISPLAY 0xA7              // SH110X_INVERTDISPLAY 0xA7
#define SSD1306_DISPLAY_OFF 0xAE                 // SH110X_DISPLAYOFF 0xAE
#define SSD1306_DISPLAY_ON 0xAF                  // SH110X_DISPLAYON 0xAF
...
#define SSD1306_SET_LOWER_COLUMN 0x00            // SH110X_SETLOWCOLUMN 0x00
#define SSD1306_SET_HIGHER_COLUMN 0x10           // SH110X_SETHIGHCOLUMN 0x10
#define SSD1306_MEMORY_ADDR_MODE 0x10            // 0x20 - SH110X_MEMORYMODE 0x20
#define SSD1306_SET_COLUMN_ADDR 0x21             // SH110X_COLUMNADDR 0x21
#define SSD1306_SET_PAGE_ADDR 0xB0               // 0x22 - SH110X_SETPAGEADDR 0xB0

// Hardware Configuration Commands
#define SSD1306_SET_START_LINE 0x40              // SH110X_SETSTARTLINE 0x40
#define SSD1306_SET_SEGMENT_REMAP 0xA1           // SH110X_SEGREMAP 0xA0
#define SSD1306_SET_MULTIPLEX_RATIO 0x3F         // 0xA8 SH110X_SETMULTIPLEX 0xA8
#define SSD1306_COM_SCAN_DIR_INC 0xC0            // SH110X_COMSCANINC 0xC0
#define SSD1306_COM_SCAN_DIR_DEC 0xC8            // SH110X_COMSCANDEC 0xC8
#define SSD1306_SET_DISPLAY_OFFSET 0x00          // 0xD3 - SH110X_SETDISPLAYOFFSET
#define SSD1306_SET_COM_PINS 0x12                // 0xDA SH110X_SETCOMPINS 0xDA
#define SSD1306_CHARGE_PUMP 0x8D                 // SH110X_CHARGEPUMP 0x8D

// Timing & Driving Scheme Setting Commands
#define SSD1306_SET_DISPLAY_CLOCK_DIV_RATIO 0x80 // 0xD5 SH110X_SETDISPLAYCLOCKDIV 0xD5
#define SSD1306_SET_PRECHARGE_PERIOD 0x1F        // 0xD9 SH110X_SETPRECHARGE 0xD9
#define SSD1306_SET_VCOM_DESELECT 0x40           // 0xDB SH110X_SETVCOMDETECT 0xD8
#define SSD1306_SET_VCOM_DESELEC2 0x33           // SH110X_SETVCOMDETECT second
...
public:
  ...
  int begin() {
    ...
    ssd1306_command(SSD1306_SET_VCOM_DESELEC2);
